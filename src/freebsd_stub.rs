...
impl Application {
  ...
  pub fn create_browser_window(
    &mut self,
    _options: Option<BrowserWindowOptions>,
...
impl BrowserWindow {
  ...
  pub fn create_webview(
    &mut self,
    _env: Env,
    _options: Option<WebviewOptions>,
  ) -> Result<JsWebview> {
    unsupported()
  }

  #[napi(js_name = "_registerProtocol")]
  pub fn register_protocol_raw(
    &mut self,
    _name: String,
    _handler: FunctionRef<String, ()>,
  ) -> Result<()> {
    unsupported()
  }
  ...
  pub fn on_window_event(
    &self,
    _handler: Option<FunctionRef<WindowEventPayload, ()>>,
  ) -> Result<()> {
    unsupported()
  }

  #[napi(getter)]
  pub fn is_child(&self) -> Result<bool> {
    unsupported()
  }
  ...
  #[napi]
  pub fn set_minimizable(&self, _minimizable: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_maximizable(&self, _maximizable: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_closable(&self, _closable: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_always_on_top(&self, _always: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_content_protection(&self, _enabled: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_visible_on_all_workspaces(&self, _visible: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_decorations(&self, _decorated: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_skip_taskbar(&self, _skip: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_fullscreen(&self, _type_: Option<FullscreenType>) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_cursor(&self, _cursor: CursorType) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_cursor_visible(&self, _visible: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  ...
  #[napi]
  pub fn get_size(&self) -> Result<Dimensions> {
    unsupported()
  }
  #[napi]
  pub fn get_outer_size(&self) -> Result<Dimensions> {
    unsupported()
  }
  #[napi]
  pub fn set_size(&self, _width: f64, _height: f64) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_min_size(&self, _w: Option<f64>, _h: Option<f64>) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_max_size(&self, _w: Option<f64>, _h: Option<f64>) -> Result<()> {
    unsupported()
  }
  #[napi]
  ...
  #[napi]
  pub fn set_position(&self, _x: f64, _y: f64) -> Result<()> {
    unsupported()
  }
  #[napi]
  ...
  #[napi]
  pub fn set_window_icon(&self, _rgba: Buffer, _width: u32, _height: u32) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_progress_bar(&self, _progress: JsProgressBar) -> Result<()> {
    unsupported()
  }
  #[napi]
  ...
  #[napi]
  pub fn set_menu(&mut self, _options: Option<MenuOptions>) -> Result<()> {
    unsupported()
  }
  #[napi]
  ...
  #[napi]
  pub fn open_file_dialog(&self, _options: Option<FileDialogOptions>) -> Result<Vec<String>> {
    unsupported()
  }
  #[napi(getter)]
  ...
  #[napi]
  pub fn set_theme(&self, _theme: Option<Theme>) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn set_window_level(&self, _level: u32) -> Result<()> {
    unsupported()
  }
}
...
impl JsWebview {
  #[napi]
  pub fn on_ipc_message(&mut self, _handler: Option<FunctionRef<IpcMessage, ()>>) -> Result<()> {
    unsupported()
  }
  ...
  pub fn expose_internal(
    &self,
    _ns: String,
    _statics_json: String,
    _fns: Vec<String>,
    _handler: FunctionRef<ExposeCallData, ()>,
  ) -> Result<()> {
    unsupported()
  }
  #[napi]
  ...
  #[napi]
  pub fn set_webview_visibility(&self, _visible: bool) -> Result<()> {
    unsupported()
  }
  #[napi]
  ...
  #[napi]
  pub fn load_url(&self, _url: String) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn load_html(&self, _html: String) -> Result<()> {
    unsupported()
  }
  #[napi]
  ...
  #[napi]
  pub fn load_url_with_headers(&self, _url: String, _headers: Vec<HeaderData>) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn get_cookies(&self, _url: Option<String>) -> Result<Vec<WebviewCookie>> {
    unsupported()
  }
  #[napi]
  pub fn set_cookie(&self, _cookie: WebviewCookie) -> Result<()> {
    unsupported()
  }
  #[napi]
  ...
  #[napi]
  pub fn set_background_color(&self, _r: u8, _g: u8, _b: u8, _a: u8) -> Result<()> {
    unsupported()
  }
  #[napi]
  pub fn get_bounds(&self) -> Result<Option<WebviewBounds>> {
    unsupported()
  }
  #[napi]
